...
<head>
    ...
    <title>Woohoo Marketplace</title>
...
<body id="app-layout">
    <nav class="navbar navbar-default">
        <div class="container">
			...
			<img src="https://stage.woohoo.in/media/smartbanner/woohoo_banner.png"></img>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li>
			<a href="{{ url('/sell-gift-card') }}">SELL GIFT CARDS</a>
		    </li>
		    <li>
			<a href="{{ url('/buy-gift-cards') }}">BUY GIFT CARDS</a>
		    </li>
                </ul>
